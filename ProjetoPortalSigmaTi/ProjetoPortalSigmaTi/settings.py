"""
Django settings for ProjetoPortalSigmaTi project.
...
SECRET_KEY = 'django-insecure-%!z*z__5+rwy68kab)ythw*=!j5lddihxxxcnxn3#hb=uyun#&'
...
ROOT_URLCONF = 'ProjetoPortalSigmaTi.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'AppHome.context_processors.permissoes_usuario',
            ],
        },
    },
]

WSGI_APPLICATION = 'ProjetoPortalSigmaTi.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "static",  # se tiver pasta static na raiz
]
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Bem Vindo ao Portal SigmaTI",
